...
is_exec_t_init = str(input("type 'yes' if you would like to execute terraform init and plan or enter any key for cancelation: "))
if is_exec_t_init == 'yes' or is_exec_t_init == 'Yes' or is_exec_t_init == 'YES':
    os.system(f'powershell.exe cd ..\\..\\terraform')
    print(os.system('powershell.exe pwd'))
    print(os.system('terraform init'))
